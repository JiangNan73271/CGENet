...
def pvt_v2_eff_b1(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        # )
        state_dict = torch.load('./pretrained_weight/pvt_v2_b1.pth')  # 从本地加载权重文件
        state_dict.pop("head.weight")
        state_dict.pop("head.bias")
        model.load_state_dict(state_dict)
    return model
...
def pvt_v2_eff_b2(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        # )
        state_dict = torch.load('./pretrained_weight/pvt_v2_b2.pth')  # 从本地加载权重文件
        state_dict.pop("head.weight")
        state_dict.pop("head.bias")
        model.load_state_dict(state_dict)
    return model
...
def pvt_v2_eff_b3(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        # )
        state_dict = torch.load('./pretrained_weight/pvt_v2_b3.pth')  # 从本地加载权重文件
        state_dict.pop("head.weight")
        state_dict.pop("head.bias")
        model.load_state_dict(state_dict)
...
def pvt_v2_eff_b4(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        # )
        state_dict = torch.load('./pretrained_weight/pvt_v2_b4.pth')  # 从本地加载权重文件
        state_dict.pop("head.weight")
        state_dict.pop("head.bias")
        model.load_state_dict(state_dict)
    return model
